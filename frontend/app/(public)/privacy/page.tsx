                ...
                <div className="bg-card/70 border backdrop-blur-md rounded-2xl p-8 md:p-12 shadow-xl relative overflow-hidden">
                    ...
                    <header className="mb-12 border-b pb-8">
                        <h1 className="text-4xl font-extrabold tracking-tight mb-4 flex items-center gap-3 bg-gradient-to-r from-green-600 to-emerald-500 bg-clip-text text-transparent">
                            <Shield className="text-green-500 w-10 h-10 shrink-0" />
                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none space-y-8 text-sm md:text-base leading-relaxed">
                        ...
                        <section className="space-y-3">
                            ...
                            <ul className="grid gap-2 pl-4 mt-2">
                                <li className="flex items-start gap-2 text-muted-foreground">
                                    ...
                                    <span>{t('legal.privacy.sections.collection.item1')}</span>
                                </li>
                                <li className="flex items-start gap-2 text-muted-foreground">
                                    <span className="h-1.5 w-1.5 rounded-full bg-green-500 mt-2 shrink-0" />
                                    <span>{t('legal.privacy.sections.collection.item2')}</span>
                                </li>
                                <li className="flex items-start gap-2 text-muted-foreground">
                                    <span className="h-1.5 w-1.5 rounded-full bg-green-500 mt-2 shrink-0" />
                                    <span>{t('legal.privacy.sections.collection.item3')}</span>
                                </li>
                                <li className="flex items-start gap-2 text-muted-foreground">
                                    <span className="h-1.5 w-1.5 rounded-full bg-green-500 mt-2 shrink-0" />
                                    <span>{t('legal.privacy.sections.collection.item4')}</span>
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="space-y-3">
                            <h2 className="text-2xl font-bold tracking-tight text-foreground flex items-center gap-2">
                                ...
                                {t('legal.privacy.sections.google.title')}
                            </h2>
                            <p className="text-muted-foreground mb-4">
                                {t('legal.privacy.sections.google.content')}
                            </p>
                            <div className="bg-green-500/5 border border-green-500/20 rounded-xl p-6 italic text-sm text-muted-foreground">
                                {t('legal.privacy.sections.google.disclosure')}
                            </div>
                        </section>
                        ...
                        <section className="space-y-3">
                            ...
                            <ul className="grid gap-2 pl-4 mt-2">
                                <li className="flex items-start gap-2 text-muted-foreground">
                                    <span className="h-1.5 w-1.5 rounded-full bg-green-500 mt-2 shrink-0" />
                                    <span>{t('legal.privacy.sections.use.item1')}</span>
                                </li>
                                <li className="flex items-start gap-2 text-muted-foreground">
                                    <span className="h-1.5 w-1.5 rounded-full bg-green-500 mt-2 shrink-0" />
                                    <span>{t('legal.privacy.sections.use.item2')}</span>
                                </li>
                                <li className="flex items-start gap-2 text-muted-foreground">
                                    <span className="h-1.5 w-1.5 rounded-full bg-green-500 mt-2 shrink-0" />
                                    <span>{t('legal.privacy.sections.use.item3')}</span>
                                </li>
                                <li className="flex items-start gap-2 text-muted-foreground">
                                    <span className="h-1.5 w-1.5 rounded-full bg-green-500 mt-2 shrink-0" />
                                    <span>{t('legal.privacy.sections.use.item4')}</span>
                                </li>
                                <li className="flex items-start gap-2 text-muted-foreground">
                                    <span className="h-1.5 w-1.5 rounded-full bg-green-500 mt-2 shrink-0" />
                                    <span>{t('legal.privacy.sections.use.item5')}</span>
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className="space-y-3">
                            <h2 className="text-2xl font-bold tracking-tight text-foreground flex items-center gap-2">
                                ...
                                {t('legal.privacy.sections.sovereignty.title')}
                            </h2>
                            <p className="text-muted-foreground">
                                {t('legal.privacy.sections.sovereignty.content')}
                            </p>
                        </section>
